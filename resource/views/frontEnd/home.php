...
<section class="home-about-area section-gap">
	...
	<img class="about-img" src="assets/frontEnd/img/about-img.png" alt="">
</section>
<!-- End home-about Area -->
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="single-cat-item">
					<div class="thumb">
						<img class="img-fluid" src="assets/frontEnd/img/c1.jpg" alt="">
					</div>	
			...
			<div class="col-lg-3 col-md-6">
				<div class="single-cat-item">
					<div class="thumb">
						<img class="img-fluid" src="assets/frontEnd/img/c2.jpg" alt="">
					</div>	
			...
			<div class="col-lg-3 col-md-6">
				<div class="single-cat-item">
					<div class="thumb">
						<img class="img-fluid" src="assets/frontEnd/img/c3.jpg" alt="">
					</div>	
			...
			<div class="col-lg-3 col-md-6">
				<div class="single-cat-item">
					<div class="thumb">
						<img class="img-fluid" src="assets/frontEnd/img/c4.jpg" alt="">
					</div>	
	...
	<div class="container">
		...
		<div class="row">
			<div class="active-review-carusel">
				...
				<div class="single-review item">
					<img src="assets/frontEnd/img/r1.png" alt="">
					<div class="title justify-content-start d-flex">
						<a href="#"><h4>Hulda Sutton</h4></a>
						<div class="star">
							<span class="fa fa-star checked"></span>
	...
	<div class="container">
		...
		<div class="row">	
			<div class="single-blog col-lg-4 col-md-4">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="assets/frontEnd/img/b1.jpg" alt="">	
				</div>
				<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
					<div>
						<img class="img-fluid" src="assets/frontEnd/img/user.png" alt="">
			...
			<div class="single-blog col-lg-4 col-md-4">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="assets/frontEnd/img/b2.jpg" alt="">	
				</div>
				<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
					<div>
						<img class="img-fluid" src="assets/frontEnd/img/user.png" alt="">
			...
			<div class="single-blog col-lg-4 col-md-4">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="assets/frontEnd/img/b3.jpg" alt="">	
				</div>
				<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
					<div>
						<img class="img-fluid" src="assets/frontEnd/img/user.png" alt="">
